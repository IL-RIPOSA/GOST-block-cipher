...
plaintext= "0000000000000000000000000000000000000001000000010001000000010001"

r2=plaintext[0:32]
r1=plaintext[32:65]

key= ""
...
for x in range (0,3):
    for j in range (0,8):
        ...
        # print("before R1:",hex(int(r1,2)),"R2:", hex(int(r2,2)))
        ...
        # print("cm1",hex(int(cm1,2)),cm1,len(cm1))
        ...
        # print("rotate",hex(int(shift_r,2)), shift_r)
        # print("r2", r2)
        ...
        # print("cm2",cm2, len(cm2))
        r2=r1
        r1=cm2
        print(x,j ,"after R2:",hex(int(r2,2)),"R1:", hex(int(r1,2)))
...
#       print("rotate", shift_r)
        ...
        r2=r1
        r1=cm2
        print(y ,"after R2:",hex(int(r2,2)),"R1:", hex(int(r1,2)))
